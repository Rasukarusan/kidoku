...
export const SuccessAlert: React.FC<Props> = ({ open, text, onClose }) => {
  ...
  return (
    <div
      id="alert-1"
      className={`mb-4 flex items-center rounded-lg bg-blue-50 p-4 text-blue-800`}
      role="alert"
    >
      <svg
      ...
      <button
        type="button"
        className="-mx-1.5 -my-1.5 ml-auto inline-flex h-8 w-8 items-center justify-center rounded-lg bg-blue-50 p-1.5 text-blue-500 hover:bg-blue-200 focus:ring-2 focus:ring-blue-400"
