  ...
  const booksData = [
    {
      ...
      impression: '-',
      memo: '[期待]\nソフトウェア業界でのキャリア構築について体系的に学びたかった。\n\n[感想]\nまだ途中だが、業界の全体像を俯瞰できる構成は良い。',
      isPublicMemo: true,
      isPurchasable: false,
    ...
    },
    {
      ...
      impression: '-',
      memo: '[期待]\nネットワークの基礎を体系的に学び直したかった。\n\n[感想]\n図解が豊富でわかりやすい。TCP/IPの全体像を掴むのに最適な入門書。',
      isPublicMemo: true,
      isPurchasable: false,
    ...
    },
    {
      ...
      impression: '◯',
      memo: '[期待]\nテレビプロデューサーの仕事術に興味があった。\n\n[感想]\n軽い読み口だが、機嫌よく仕事をするための知恵が詰まっている。「不機嫌は周りへの暴力」という言葉が刺さった。',
      isPublicMemo: true,
      isPurchasable: false,
      finished: new Date('2025-03-27'),
    ...
    },
    {
      ...
      impression: '◎',
      memo: '[期待]\n思考のスピードを上げる方法を知りたかった。\n\n[感想]\nA4メモ書きのメソッドはシンプルだが効果的。1分で書き切るという制約が思考の瞬発力を鍛えてくれる。実際に続けてみると頭の中が整理される感覚がある。',
      isPublicMemo: true,
      isPurchasable: false,
    ...
    },
    {
      ...
      impression: '◎',
      memo: '[期待]\nWeb技術の全体像を改めて整理したかった。\n\n[感想]\nHTTPからセキュリティまで幅広くカバーしていて、改訂版で内容も新しい。初心者にも薦められるし、経験者が知識を再確認するのにも良い。',
      isPublicMemo: true,
      isPurchasable: false,
      finished: new Date('2025-05-04'),
      created: new Date('2025-05-11'),
