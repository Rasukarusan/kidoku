...
async function main() {
  ...
  await prisma.aiSummaries.create({
    data: {
      ...
      analysis: {
        summary:
          'ビジネス書・哲学書を中心に幅広く読んでおり、人生の目的や働き方に関する内省的なテーマへの関心が高い。技術書も定期的に読んでおり、Software Designの定期購読が見られる。',
        categories: [
          { name: 'ビジネス・自己啓発', count: 7 },
          { name: '技術・コンピュータ', count: 6 },
          { name: '哲学・人生論', count: 4 },
          { name: 'お金・投資', count: 2 },
        ],
        recommendation:
          '「暇と退屈の倫理学」や「ライフシフト」を読むとさらに考えが深まるでしょう。',
      },
      token: 1800,
    },
  })
