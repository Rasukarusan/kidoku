...
export default async function handler(
  ...
  try {
    ...
    const nestjsEndpoint = process.env.NESTJS_GRAPHQL_ENDPOINT?.replace('/graphql', '') || 'http://localhost:4000'
    ...
    const response = await fetch(`${nestjsEndpoint}/software-design/batch/add-latest`, {
      method: 'POST',
      headers: {
