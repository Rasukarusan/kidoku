...
export const OnThisDay: React.FC = () => {
  ...
  useEffect(() => {
    ...
    return () => toggleNoScrollBody(false)
  }, [open])
        ...
        <>
          ...
          <div className="pointer-events-none fixed inset-0 z-50 flex items-center justify-center p-4">
            <motion.div
              ...
              className="pointer-events-auto max-h-[calc(100dvh-2rem)] w-full max-w-md overflow-y-auto rounded-2xl bg-white p-6 shadow-2xl"
              role="dialog"
              aria-modal="true"
              aria-label="あの日の一冊"
            >
