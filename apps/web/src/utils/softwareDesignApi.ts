 ...
 */
export const extractYearMonthFromISBN = (
  _isbn: string
 ...
 */
export const generateSoftwareDesignImageUrl = (
  year: number,
  month: number
): string => {
 ...
 */
export const generateSoftwareDesignDetailUrl = (
  year: number,
  month: number
): string => {
  const yearStr = year.toString()
 ...
 */
export const getLatestSoftwareDesign = async (): Promise<
 ...
 */
export const getSoftwareDesignByYear = async (
  year: number
